...
function Object:testPrint(
word --[[string]]
)
--print(word)
end

function Object:addToHandler(
object --[[table]],
objectHandler --[[table]]
)
...
if
cur_obj_x < other_obj_x + other_obj_w
and cur_obj_x + cur_obj_w > other_obj_x
and cur_obj_y < other_obj_y + other_obj_h
and cur_obj_y + cur_obj_h > other_obj_y
then
...
function Object:collisionMoveX(
collide_list --[[table]]
)
